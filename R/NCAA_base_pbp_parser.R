...
ncaa_parse=function(pbp_data_frame){
  ...
  pbp_data_frame=pbp_data_frame%>%
    ...
    select(year,date,game_id,away_team,home_team,inning,top_inning,away_score,home_score,away_text,home_text,bat_order,bat_name,r1_name,r2_name,r3_name,sub_fl,sub_in,sub_out,
